...
VERIFIED_RESULTS = {
    "北京市": {
        ...
        "biopharma": ("高精尖产业段", "34款创新药械获批，国际医药创新公园新引入8家跨国药企并继续建设。"),
    },
    "上海市": {
    ...
    "武汉市": {
        ...
        "biopharma": ("PDF第2、13页", "已有一类创新药上市，并部署创新药、医疗器械研发制造和国际医疗创新高地。"),
    },
    "浙江省": {
    ...
    "深圳市": {
        ...
        "biopharma": ("生物医药产业段", "规划建设光明、坪山生物医药制造园和龙华高端医疗器械产业城。"),
    },
    "苏州市": {
        "integrated-circuits": None,
